...
#     # user_data = serialize('json', [request.user])
#     user_data = serialize('json', [request.user], use_natural_primary_keys=True, fields=('id', 'username', 'first_name', 'last_name', 'email', 'userprofile__profile_picture'))
